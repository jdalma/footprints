...
- [**코틀린과 유니코드**](#%EC%BD%94%ED%8B%80%EB%A6%B0%EA%B3%BC-%EC%9C%A0%EB%8B%88%EC%BD%94%EB%93%9C)
- [**코틀린의 문자열**](#%EC%BD%94%ED%8B%80%EB%A6%B0%EC%9D%98-%EB%AC%B8%EC%9E%90%EC%97%B4)
- [**수 타입간의 타입 변환**](#%EC%88%98-%ED%83%80%EC%9E%85%EA%B0%84%EC%9D%98-%ED%83%80%EC%9E%85-%EB%B3%80%ED%99%98)
...
하지만 더 이상 코드 포인트를 2바이트 만으로는 표현할 수 없기 때문에 UCS-2를 확장한 `UTF-16`에서는 **BMP에 속하는 코드 포인트는 그대로 2바이트를 사용하되, BMP를 벗어나는 코드 포인트는 서로게이트라는 방식을 사용해 20비트 유니코드 코드 포인트를 표현한다.**  
