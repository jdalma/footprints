...
- [**Singleton Pattern**](#singleton-pattern)
  - [`private` 생성자에 `static` 메소드 방법](#private-생성자에-static-메소드-방법)
  - [`synchronized` 키워드 사용](#synchronized-키워드-사용)
  - [이른 초기화 `eager initialization` 사용하기](#이른-초기화-eager-initialization-사용하기)
  - [`double checked locking` 사용하기](#double-checked-locking-사용하기)
  - [`static inner class` 사용하기 (권장하는 방법 중의 하나)](#static-inner-class-사용하기-권장하는-방법-중의-하나)
    - [Reflection을 이용하여 싱글톤 깨트리기](#reflection을-이용하여-싱글톤-깨트리기)
    - [직렬화 \& 역직렬화를 이용하여 싱글톤 깨트리기](#직렬화--역직렬화를-이용하여-싱글톤-깨트리기)
  - [`enum` 사용하기](#enum-사용하기)
  - [질문](#질문)
  - [자바와 스프링에서 사용되는 곳](#자바와-스프링에서-사용되는-곳)
...
- [**Factory Method Pattern**](#factory-method-pattern)
  - [**Before**](#before-1)
  - [**After**](#after-1)
  - [**After** (+ `Interface`적용)](#after--interface적용)
  - [**질문**](#질문-1)
  - [실무 적용 예시](#실무-적용-예시-1)
